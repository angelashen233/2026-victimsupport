...
const App: React.FC = () => {
  ...
  React.useEffect(() => {
    ...
    if (darkMode) {
      // High quality Unsplash image for dark mode
      body.style.backgroundImage = "url('https://images.unsplash.com/photo-1500534314209-a25ddb2bd429?auto=format&fit=crop&w=1500&q=80')";
