...
const App: React.FC = () => {
  ...
  React.useEffect(() => {
    ...
    if (darkMode) {
      ...
      // 4K Unsplash image for light mode (3840px)
      body.style.backgroundImage = "url('https://images.unsplash.com/photo-1465101046530-73398c7f28ca?auto=format&fit=crop&w=3840&q=80')";
      body.style.backgroundSize = "cover";
      body.style.backgroundPosition = "center";
