...
const App: React.FC = () => {
  ...
  body.style.backgroundImage = "url('https://images.unsplash.com/photo-1508402476522-c77c2fa4479d?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')"; // Updated user-provided image for bright mode
      body.style.backgroundSize = "cover";
      body.style.backgroundPosition = "center";
