...
const App: React.FC = () => {
  ...
  React.useEffect(() => {
    ...
    if (darkMode) {
      ...
      // 4K Unsplash image for light mode (bright, nature, mountains)
      body.style.backgroundImage = "url('https://images.unsplash.com/photo-1501785888041-af3ef285b470?auto=format&fit=crop&w=3840&q=80')";
      body.style.backgroundSize = "cover";
      body.style.backgroundPosition = "center";
