                ...
                {showActionMenu && (
                     <div ref={actionMenuRef} className="absolute bottom-full left-0 mb-2 w-48 bg-slate-700 border border-slate-600 rounded-lg shadow-lg overflow-hidden">
                        ...
                        <textarea
                            ...
                            rows={1}
                            className="w-full py-5 text-base text-slate-200 transition-colors duration-200 border rounded-full resize-none bg-slate-700 border-slate-600 focus:outline-none focus:ring-2 focus:ring-sky-500 text-center"
                        />
