        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative flex-1">
            ...
            <div className="absolute inset-y-0 right-0 flex items-center pr-1">
                ...
                className="flex items-center justify-center w-12 h-12 text-white transition-colors duration-200 rounded-full bg-sky-600 hover:bg-sky-700 disabled:bg-sky-800 disabled:cursor-not-allowed"
                >
                <SendIcon />
                </button>
            </div>
