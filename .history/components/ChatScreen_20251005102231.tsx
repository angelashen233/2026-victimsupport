        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative flex-1">
            ...
            <textarea
              ...
              rows={1}
                            className="w-full px-12 py-3 pr-28 text-base text-slate-200 transition-colors duration-200 border resize-none bg-slate-700 border-slate-600 focus:outline-none focus:ring-2 focus:ring-sky-500"
                            style={{
                                borderRadius: '2rem',
