...
const App: React.FC = () => {
  ...
  const menuRef = useRef<HTMLDivElement>(null);
    ...
    // Example: handle agent response
    // Usage: Call handleAgentReply with user input and your agent instance
    const handleAgentReply = async (userInput: string, agent: Chat) => {
