...
const App: React.FC = () => {
  ...
  React.useEffect(() => {
    ...
    if (darkMode) {
      // HD Unsplash image for dark mode (1920px+)
      ...
      // HD Unsplash image for light mode (1920px+)
      body.style.backgroundImage = "url('https://images.unsplash.com/photo-1465101046530-73398c7f28ca?auto=format&fit=crop&w=1920&q=80')";
      body.style.backgroundSize = "cover";
      body.style.backgroundPosition = "center";
