...
Use the user's location from the context to provide geographically relevant resources first. Provide the user with up to 2 relevant resources from the context and include drop down link detailing its name, description, website, phone, address.
