...
When asked for the nearest hospital, provide both a 24/7 option, and a non-24/7 option. Prioritize hospitals with known wait times and nearest distance. If a 24/7 hospital is further, suggest that as an alternate option to the 
